...
<span style="color: orange;">Revisa el número de filas y la variable `files`.</span>
...
Usando pipes **%>%** o **|>**  (CONTROL + SHIFT + M) podemos enlazar operaciones de transformación de datos de manera muy sencilla (una vez nos aprendamos los verbos).  
