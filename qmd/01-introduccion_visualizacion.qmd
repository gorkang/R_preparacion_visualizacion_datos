...
<span style="color: orange;">[Las pruebas de normalidad son muy sensibles al n de la muestra](https://stats.stackexchange.com/questions/2492/is-normality-testing-essentially-useless)</span>
...
Para empezar a usar ggplot sin tener que preocuparnos de su complejidad, podemos usar la función `esquisse:::esquisser()` del paquete [esquisse](https://www.williamrchase.com/). Esta nos permite usar la potencia de ggplot para explorar una base de datos de manera muy sencilla.   
...
<span style="color: orange;">En la sección [Combinando gráficas](02-visualizacion-avanzada.html#combinando-graficas) verás un ejemplo del uso de la función cowplot::plot_grid()</span>
...
<span style="color: orange;">Tienes que usar el `geom_bar()` y el parámetro `fill`.</span>
