...
Como en cada capítulo, crea un nuevo script de R (CNTRL+ SHIFT + N), guárdalo como `capitulo2.R`, copia y pega las líneas de abajo y ejecútalas (CNTRL + ENTER para ejecutar linea a linea).    
...
O la mediana más la desviación estandardice:
...
1) Usando como base este plot, podrías cambiarle la paleta de color para usar una de las paletas cualitativas?
...
2) Ahora, usando el gráfico de abajo como base, puedes asignar manualmente colores a los continentes? 
...
Un tipo de gráfica genial para mostrar simultáneamente observaciones individuales, distribuciones, y cambios, es el [raincloudplot](https://github.com/njudd/ggrain).
