...
<details><summary>Lo mejor es dividir el proceso en varios pasos![](../data/images/hint.png)</summary><span style="color: orange;">1) Empieza con el histograma de arriba. <BR>2) recuerda que puedes usar el parámetro `fill` (dentro de aes), para asignar un color de relleno por nivel de una variable categórica. <BR>3) Finalmente, usando facetas podrás crear una gráfica para cada nivel de la variable categórica [facet_wrap()!](#facet_wrap)</span></details>
...
<details><summary>La solución está en el capítulo 1![](../data/images/hint.png)</summary><span style="color: orange;">El paquete [gghighlight](#gghighlight-y-facet_wrap) es justo lo que necesitas</span></details>
...
<details><summary>Visualizando una variable categórica y una continua![](../data/images/hint.png)</summary><span style="color: orange;">[geom_density_ridges()!](#variable-categórica-y-continua)</span></details>

<details><summary>Visualizando pares de variables continuas![](../data/images/hint.png)</summary><span style="color: orange;">[geom_smooth()!](#geom_smooth)</span></details>
...
<details><summary>Como visualizar todas las variables![](../data/images/hint.png)</summary><span style="color: orange;">[Ver el apartado visualizando-datasets-completos en este mismo capítulo](#visualizando-datasets-completos)</span></details>
