...
Podéis ver ejemplos de [tablas de descriptivos](#tablas-descriptivos) o [tablas de resultados inferenciales](#tablas-resultados-inferenciales) en el capítulo anterior, y de gráficas en los capítulos de [Introducción a la visualización](#visualización-de-datos-con-ggplot2) y [Visualización avanzada](#facets).  
