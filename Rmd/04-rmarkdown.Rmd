...
4. Ahora cierra el proyecto. Y clona el repositorio que has creado en una nueva carpeta  
...
Es importante ser consistente en la manera de escribir codigo. Habitualmente se recomienda seguir una guia de estilo. Por ejemplo, [Hadley Wickham's Style guide](http://adv-r.had.co.nz/Style.html) o la [guia de estilo del tidyverse](https://style.tidyverse.org/).
