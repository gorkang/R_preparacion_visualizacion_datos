...
```{r install_workshop_packages, message=FALSE, warning=FALSE}
  ...
  rlang::check_installed(pkg = c("afex", "correlation", "corrr", "cowplot", "dplyr", "DT", "esquisse",
                                 "gapminder", "ggplot2", "ggraph", "ggridges", "ggthemes", "googlesheets4", "gtsummary", "haven", "here", "hexbin", 
