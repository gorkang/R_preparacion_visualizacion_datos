...
list_of_packages = c("bookdown", "corrplot", "cowplot", "easystats", "esquisse", "gapminder",
                     "ggpubr", "gganimate", "ggridges", "ggthemes", "hrbrthemes", "inspectdf",
                     "janitor", "knitr", "plotly", "psych", "remotes", "stringr", "tictoc",
                     "tidyverse", "usethis", "yarrr")  
