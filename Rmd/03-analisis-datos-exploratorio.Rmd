...
gapminder %>% inspect_na
gapminder %>% inspect_na %>% show_plot + coord_flip()

gapminder_cat <- gapminder %>% inspect_cat()
gapminder_cat %>% show_plot()


gapminder_num <- gapminder %>% inspect_num()
gapminder_num %>% show_plot()
...
# naniar::gg_miss_upset(gapminder)
