...
Puedes consultar el [manual de jsPsychR](https://gorkang.github.io/jsPsychR-manual/) para más detalles.  
...
En el [manual de jsPsychR](https://gorkang.github.io/jsPsychR-manual/jsPsychMaker.html#available-tasks) puedes ver las tareas disponibles junto con una breve descripción de cada una de ellas.    

Si quieres consultar los [scrips de las tareas](https://github.com/gorkang/jsPsychMaker/tree/main/canonical_protocol/tasks) puedes hacerlo en la carpeta `canonical_protocol/` del repositorio de [jsPsychMaker](https://github.com/gorkang/jsPsychMaker).  
...
- Editamos `config.js` para indicar las tareas que queremos usar en la seccion `// ORDER OF TASKS`  
