...
name_of_sheet = "1EK5Be4r3eh4QkFjfLvutPYGNhI_MBa4TyIt3rtkJk2c"
...
<details><summary>Pista: ![](data/images/hint.png)</summary><span style="color: orange;">Tendras que usar la función `select()` y el select helper `everything()` para el primer paso.</span></details>
...
[Basic Regular Expressions Cheatsheet](https://www.rstudio.com/wp-content/uploads/2016/09/RegExCheatsheet.pdf). [Introduction to Regular Expressions](https://tobyhodges.gitbooks.io/introduction-to-regular-expressions/content/).  

![SOURCE: https://xkcd.com/208/](`r here::here("data/images/regular_expressions.png")`)


Usando este dataframe:  
...
# Estrategia A2 - wide con nombres de variables
DF_A2 = 
  df_wide_raw %>% 
  # select(ID, matches("WMAT_[0-9]{2}_cod")) %>%
...
El método más sencillo. Símplemente unimos las filas o columnas de los dataframes.  
...
Caret ha sido desplazado por {[tidymodels](https://www.tidymodels.org/)}, un conjunto de paquetes que emplean la filosofía del {[tidyverse](https://www.tidyverse.org/)}.  
