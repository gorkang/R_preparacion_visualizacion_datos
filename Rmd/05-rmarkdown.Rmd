...
Usando la base de Cancer Screening Risk Literacy of Physicians in Training: https://osf.io/qn9a2/ y el [preprint del artículo](https://github.com/gorkang/R_preparacion_visualizacion_datos/raw/master/data/files/04-Dafina-PLOS/PONE-D-19-03821R2_FTC.pdf):
...
DF = haven::read_sav(here::here("data/files/Dafina/Cancer screening risk literacy R1.sav")) %>%
  select(IDparticipante, gender, Edad, Sexo, screenbeliefs, numeracy, sciliteracy, statsed, benefits, harms, recommendation)
...
2. Tratad de emular el tipo de análisis que se ve en la Tabla 4. Podéis hacer una regresión lineal prediciendo `recommendation` con algunas de las variables que usamos en la correlación anterior.   
