...
2)  Abrimos `run.R` y seguimos las instrucciones. En esencia:
    ...
    -   Ponemos datos en la carpeta `data/ID_PROTOCOLO` (**reemplazar ID_PROTOCOLO por el número de nuestro protocolo**. Si lo desconoces, es el primer número de tus archivos de datos, antes del "_").
