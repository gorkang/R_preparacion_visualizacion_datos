...
Scatterplot donde se puede ver el valor de los puntos, seleccionar áreas, etc.
...
Surface plots donde se muestra la relación entre 3 variables en un entorno interactivo 3D.  
