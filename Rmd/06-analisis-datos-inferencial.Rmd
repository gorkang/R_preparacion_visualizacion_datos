...
```{r setup-06, message=FALSE, warning=FALSE}
...
<details><summary>Donde encontrar ayuda![](`r here::here("data/images/hint.png")`)</summary><span style="color: orange;">En el [manual de gtsummary](https://www.danieldsjoberg.com/gtsummary/articles/tbl_summary.html) tienes ejemplos para todo lo que necesitarás. Busca a la función `tbl_summary()`</span></details>  

<details><summary>Demasiado detalle, solo quiero los promedios[](`r here::here("data/images/hint.png")`)</summary><span style="color: orange;">Puedes usar `type = list(everything() ~ 'continuous'),` dentro de `tbl_summary()` para forzar el tratamiento de variables con pocos niveles como continuas.</span></details>  
...
<details><summary>Donde encontrar ayuda![](`r here::here("data/images/hint.png")`)</summary><span style="color: orange;">En el [manual de gtsummary](https://www.danieldsjoberg.com/gtsummary/articles/tbl_regression.html) tienes ejemplos para todo lo que necesitarás. `tbl_regression()` es tu amiga.</span></details>  


<details><summary>Como añadir información en el pie de la tabla[](`r here::here("data/images/hint.png")`)</summary><span style="color: orange;">Tendrás que usar la función `add_glance_source_note()` o `add_glance_table()`. Para saber que nombres poner en el paràmetro `include`, puedes usar la función `broom::glance(model)`
</span></details>  
